...
let choices = [
  {
    name: "Development",
    value:
      "api|graphql|microservice|gateway|typescript_nodejs-apollo-expressjs|run_development",
    run:
  ...
  choices = appendObjTo(choices, [
    {
      name: "Build",
      value:
        "api|graphql|microservice|gateway|typescript_nodejs-apollo-expressjs|run_build",
      run:
    ...
    },
    {
      name: "Start",
      value:
        "api|graphql|microservice|gateway|typescript_nodejs-apollo-expressjs|run_start",
      run:
    ...
    },
    {
      name: "Test",
      value:
        "api|graphql|microservice|gateway|typescript_nodejs-apollo-expressjs|run_test",
      run:
    ...
    },
    {
      ...
      value:
        "api|graphql|microservice|gateway|typescript_nodejs-apollo-expressjs|run_install_dependencies_all",
      run:
    ...
    },
    {
      ...
      value:
        "api|graphql|microservice|gateway|typescript_nodejs-apollo-expressjs|run_install_dependencies_dev",
      run:
    ...
    },
    {
      ...
      value:
        "api|graphql|microservice|gateway|typescript_nodejs-apollo-expressjs|run_install_dependencies_prod",
      run:
    ...
    },
    {
      name: "Clean cache",
      value:
        "api|graphql|microservice|gateway|typescript_nodejs-apollo-expressjs|run_clean_cache",
      run:
    ...
    },
    {
      name: "Lint",
      value:
        "api|graphql|microservice|gateway|typescript_nodejs-apollo-expressjs|run_lint",
      run:
